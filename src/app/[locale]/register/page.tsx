    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f7f3e9] px-4">
      <div className="w-full max-w-md bg-[#fefcf5] border-2 border-[#1c1410] p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-xs font-black uppercase tracking-widest text-[#1c1410] mb-1">
              {t('name')}
            </label>
            <input
              id="name"
        ...
        <p className="mt-6 text-center text-xs text-[#5c3d2e] uppercase tracking-wide">
          {t('haveAccount')}{' '}
          <Link href={`/${locale}/login`} className="text-[#c8860a] hover:underline font-black">
            {t('signIn')}
          </Link>
        </p>
      </div>
